...
function GetArduinodata() {
  ...
  xhttp.onreadystatechange = function() {
    ...
    document.getElementById("Sped3").innerHTML = spee3 + "s";
...
<tr>
    <table>
        ...
        <input style="width:58%" type="range" name="Speed3" min="2" max="240" value="10" class="slider" id="mySpeed3">
        <button class="button-blue" onclick="myFunctionS3()" style="width:20%"><b><span>Timer</span></b></button>
